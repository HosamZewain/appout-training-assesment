        ...
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <motion.div
                    ...
                    className="lg:col-span-1 bg-gradient-to-br from-slate-800/50 to-slate-900/50 border border-slate-700/50 rounded-2xl p-6 backdrop-blur-xl"
                >
                    <h2 className="text-lg font-semibold text-white mb-4">Can Attend in Tanta</h2>
